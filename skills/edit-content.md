...
3. Imágenes: paths actuales `/src/assets/images/...` (Vite). Mantener convención o migrar a `public/` con decisión.
...
Categorías filtro UI: All / Fintech / Health / E-Commerce — alinear `project.category`.
