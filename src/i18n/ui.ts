...
const ui = {
  es: {
    ...
    printCv: 'Imprimir CV',
    printCvTitle: 'Imprimir o guardar PDF en formato Harvard',
    workExperience: 'Experiencia Laboral',
    education: 'Formación',
    languages: 'Idiomas',
    profileSummary: 'Perfil',
    skillsSection: 'Habilidades',
    printWorkExperience: 'Experiencia',
    printEducation: 'Educación',
    printLanguages: 'Idiomas',
    langSpanish: 'Español',
  ...
  en: {
    ...
    printCv: 'Print CV',
    printCvTitle: 'Print or save Harvard-format PDF',
    workExperience: 'Work Experience',
    education: 'Education',
    languages: 'Languages',
    profileSummary: 'Profile',
    skillsSection: 'Skills',
    printWorkExperience: 'Experience',
