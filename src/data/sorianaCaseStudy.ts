...
export const SORIANA_CASE_SECTIONS_ES: CaseStudySection[] = [
  ...
  },
  {
    ...
    kicker: 'Ownership',
    accent: 'white',
    body: 'Como Sr. Product Designer en TS4, lideré discovery para acordar definiciones que hicieran el flujo de compra y tracking de envío mucho más claros y eficientes con las herramientas que nos ofrecía desarrollo.',
    ...
    items: [
      {
        ...
        text: 'Estado del envío en el detalle de pedido + emails de seguimiento. Salesforce no contaba con una herramienta de tracking, por lo que el módulo fue embebido de un sistema externo.',
      },
      {
        icon: 'layout-panel',
